defmodule Cerbero.CLI.Format.SARIF do
  ...
  @rule_descriptions %{
    "column_default_rewrite" => "Adding a column with a default that forces a full-table rewrite under an exclusive lock",
    "column_type_change" => "Column type change that rewrites the table or rebuilds indexes at production scale",
    ...
    "fk_validation_scan" => "ADD FOREIGN KEY scans the referencing table while blocking writes on the referenced table",
